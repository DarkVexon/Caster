...
public abstract class AbstractCasterPower extends AbstractPower {
    ...
    public AbstractCasterPower(String ID, String NAME, PowerType powerType, boolean isTurnBased, AbstractCreature owner, int amount) {
        this.ID = ID;
