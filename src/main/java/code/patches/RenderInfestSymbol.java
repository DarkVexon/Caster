...
public class RenderInfestSymbol {
    private static final TextureAtlas.AtlasRegion smallIcon = ImageHelper.asAtlasRegion(TexLoader.getTexture("casterResources/images/ui/SmallInfestIcon.png"));
        ...
        public static void Insert(AbstractCard __instance, SpriteBatch sb,
            ...
            if (tmp[0].length() > 0 && tmp[0].charAt(0) == '[') {
                ...
                if (key.equals("[bug]")) {
                    ...
                    renderSmallNote(__instance, sb, smallIcon,
            ...
            if (tmp[0].length() > 0 && tmp[0].charAt(0) == '[') {
                ...
                if (key.equals("[bug]")) {
                    ...
                    try {
                        ...
                        renderSmallEnergy.invoke(__instance, sb, smallIcon,
